...
module.exports = {
    run: async (message, args) => {
        ...
        .setTitle(`tempmute de ` + member)
        .setDescription(`Durée du mute ${humanizeDuration(duration, {language: 'fr'})}`))
        setTimeout(() => {
    ...
    guildOnly: true,
    help: {
        description: 'permet de tempmute un membre .',
        syntax: '+ { membre as mute } + { temp en s }'
    }
}